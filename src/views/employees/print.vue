        ...
        <div v-if="type === 'personal'" id="myPrint">
          ...
          <table cellspacing="0" width="100%" class="tableList">
            ...
            <tr>
              ...
              <td rowspan="5" style="width:10%"><img v-imagerror="require('@/assets/common/1.jpg')" style="width:155px;height:218px" :src="formData.staffPhoto" /></td>
            </tr>
            <tr>
              <th>性别</th>
            ...
            <tr>
              <th>出生日期</th>
              <td colspan="6">{{ formData.dateOfBirth | dateFormat }}</td>
            </tr>
            <tr>
              <th>最高学历</th>
...
<script>
import { getPersonalDetail, getUserJobDetail } from '@/api/employees'
...
export default {
  ...
  methods: {
    ...
    async getJobDetail() {
      ...
      const jobInfo = await getUserJobDetail(this.userId) // 获取个人基本信息
